...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredCategoryAppList = appsList.filter(
      eachApp => eachApp.category === activeTabId,
    )
    const filteredAppList = filteredCategoryAppList.filter(eachApp =>
      ...
      <div className="app-container">
        <div className="app-store-container">
          ...
          <ul className="app-item-container">
            {filteredAppList.map(eachAppDetails => (
              <AppItem
                appItemDetails={eachAppDetails}
